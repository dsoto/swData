...
pitchAngle         = fgetl(fileHandle); % pitch angle
rollAngle          = fgetl(fileHandle); % roll angle
fgetl(fileHandle); % blank line
...
plotFileName = sprintf('sb_x%s_y%s_v%s_p%03d_r%03d', ... 
	x,y,velocity,pitchAngle,rollAngle);
