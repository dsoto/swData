...
columnHeaders{5} = {'Slant',      'Angle',     ''    ,    formatString15};
columnHeaders{6} = {'Roll',       'Angle',     ''    ,    formatString15};
columnHeaders{7} = {'Max',        'Adhesion',  '(uN)',    formatString15};
columnHeaders{8} = {'Max',        'Shear',     '(uN)',    formatString15};
columnHeaders{9} = {'Effective',  'Preload',   '(um)',    formatString15};
